...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-[#4A3F35] to-[#3A302A] text-white pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 md:gap-16 mb-12 sm:mb-16 md:mb-20">
          <div className="text-right lg:col-span-2">
            <Link href="/" className="inline-block mb-6">
              <Image src="/12345.jpg" alt="صالون شهد - SALON SHAHD" width={160} height={55} className="h-14 w-auto object-contain" />
            </Link>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://www.facebook.com/share/1KPfh6zHby/?mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-[#C9A882] transition-all duration-300 border border-white/5 hover:scale-110"
              >
          ...
          <div className="text-right">
            ...
            <ul className="space-y-4 font-body text-white/75 leading-[1.7]">
              ...
              <li dir="ltr" className="text-right">052-311-3828</li>
              <li>Arefajbareen3@gmail.com</li>
        ...
        <div className="bg-white/5 backdrop-blur-md rounded-[2rem] p-10 mb-16 border border-white/10">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex gap-3">
              <button
                type="button"
                className="px-8 sm:px-10 py-4 min-h-[48px] bg-gradient-to-l from-[#C9A882] to-[#B8956F] text-white rounded-full font-body font-medium whitespace-nowrap shadow-xl hover:shadow-[#C9A882]/30 transition-all duration-300"
              >
                اشتركي الآن
              </button>
              <input
